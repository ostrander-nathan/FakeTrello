...
namespace FakeTrello.Tests.DAL
{
    ...
    public class FakeTrelloRepoTests
    {
        ...
        public List<Board> fake_boards_table { get; set; }


        [TestInitialize]
        public void Setup()
        {
            fake_boards_table = new List<Board>();
        ...
        public void CreateFakeDatabase() // UTILITY METHOD
        {
            query_boards = fake_boards_table.AsQueryable();// Re-express this list as something that understands queries
            // Hey LINQ use the Provider from our *cough* fake board table/list
            ...
            mock_boards_set.Setup(b => b.Add(It.IsAny<Board>())).Callback((Board board) => fake_boards_table.Add(board));
        ...
        {
            //Arrange
            fake_boards_table.Add(new Board { Name = "My Board" });
            CreateFakeDatabase();
        ...
        {
            //Arrange
            fake_boards_table.Add(new Board { BoardId = 1, Name = "My Board" });
            CreateFakeDatabase();
